...
//          </article>
//
	 $id_poveste = mysql_real_escape_string($_GET['id']);	
       $sql = "SELECT * FROM POVESTI WHERE ID_POVESTE=".$id_poveste;
...
?>
   <!--        echo "<article class=\"article by\" >";
              echo "<h4>".$titlu."</h4>";
               echo "<h5>".$data."</h5>";
               echo "<p>".$text."</p>";
               echo "<h5><a href=\"povesti.php?id=".$id_pov."\">Citeste mai mult</a></h5>";
                echo "<img class=\"by\" src=\"".$poza."\" /><h6>".$nume."</h6>";
            echo "</article>";
        }-->
        
      
<h2 class="titlu"><?php echo $titlu;?></h2>
<div class="articol">
<p><?php echo $text;?></p>

<p>by <?php echo $nume;?></p>
