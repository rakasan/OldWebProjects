...
<form action="stergere1.php" method="post">
 <table>
<tr><td>Titlul cartii: </td><td><input type="text" name="Titlu" /></td></tr>
<tr><td>Editura:</td><td><input type="text" name="Editura" /></td></tr>
<tr><td>Autor: </td><td><input type="text" name="Autor"  /></td></tr>

<tr><td><input type="submit" name="Cautare" value="Cauta" /></td><td><input type="reset" value="Reseteaza-ma"  /></td></tr>
 </table>
</form>
